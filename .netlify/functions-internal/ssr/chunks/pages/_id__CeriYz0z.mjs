...
import 'html-escaper';
import 'cssesc';
import { c as createAstro, d as createComponent, r as renderTemplate, m as maybeRenderHead, e as renderComponent, f as addAttribute, g as renderSlot, h as renderHead, i as renderTransition } from '../astro_D9J-35kJ.mjs';
import 'kleur/colors';
import cn from 'clsx';
...
}, "C:/Users/ManDenDev/Workspace/aprendiendo-astro/projects/01-spotify-clone/src/icons/Time.astro", void 0);
...
const Slider = React.forwardRef(
  ({ className, ...props }, ref) => /* @__PURE__ */ jsxs(SliderPrimitive.Root, { ref, className: cn("relative flex touch-none select-none items-center group", className), ...props, children: [
...
}, "C:/Users/ManDenDev/Workspace/aprendiendo-astro/projects/01-spotify-clone/src/icons/Library.astro", void 0);
...
}, "C:/Users/ManDenDev/Workspace/aprendiendo-astro/projects/01-spotify-clone/src/icons/Home.astro", void 0);
...
}, "C:/Users/ManDenDev/Workspace/aprendiendo-astro/projects/01-spotify-clone/src/icons/Search.astro", void 0);
...
const $$SideMenuItem = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<li> <a class="flex gap-4 text-zinc-400 hover:text-zinc-100 items-center py-3 px-5 font-medium"${addAttribute(href, "href")}> ${renderSlot($$result, $$slots["default"])} </a> </li>`;
}, "C:/Users/ManDenDev/Workspace/aprendiendo-astro/projects/01-spotify-clone/src/components/SideMenuItem.astro", void 0);
...
const $$SideMenuCard = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(`/playlist/${id}`, "href")} class="playlist-item flex relative p-2 overflow-hidden items-center gap-5 rounded-md hover:bg-zinc-800"> <picture class="size-12 flex-none"> <img${addAttribute(cover, "src")}${addAttribute(`Cover of ${title} by ${artistsString}`, "alt")} class="object-cover size-full rounded-md"> </picture> <div class="flex flex-auto flex-col truncate"> <h4 class="text-white text-sm">${title}</h4> <span class="text-xs text-gray-400">${artistsString}</span> </div> </a>`;
}, "C:/Users/ManDenDev/Workspace/aprendiendo-astro/projects/01-spotify-clone/src/components/SideMenuCard.astro", void 0);

const $$Astro$3 = createAstro();
const $$AsideMenu = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$3, $$props, $$slots);
  Astro2.self = $$AsideMenu;
  return renderTemplate`${maybeRenderHead()}<nav class="flex flex-col flex-1 gap-2"> <div class="bg-zinc-900 rounded-lg p-2"> <ul> ${renderComponent($$result, "SideMenuItem", $$SideMenuItem, { "href": "/" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "HomeIcon", $$Home, {})} Inicio
` })} ${renderComponent($$result, "SideMenuItem", $$SideMenuItem, { "href": "/#" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "SearchIcon", $$Search, {})} Buscar
` })} </ul> </div> <div class="bg-zinc-900 rounded-lg p-2 flex-1"> <ul> ${renderComponent($$result, "SideMenuItem", $$SideMenuItem, {}, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "LibraryIcon", $$Library, {})} Tu biblioteca
` })} ${playlists.map((playlist) => renderTemplate`${renderComponent($$result, "SideMenuCard", $$SideMenuCard, { "playlist": playlist })}`)} </ul> </div> </nav>`;
}, "C:/Users/ManDenDev/Workspace/aprendiendo-astro/projects/01-spotify-clone/src/components/AsideMenu.astro", void 0);
...
}, "C:/Users/ManDenDev/Workspace/aprendiendo-astro/projects/01-spotify-clone/node_modules/astro/components/ViewTransitions.astro", void 0);
...
}, "C:/Users/ManDenDev/Workspace/aprendiendo-astro/projects/01-spotify-clone/src/layouts/Layout.astro", "self");
...
}, "C:/Users/ManDenDev/Workspace/aprendiendo-astro/projects/01-spotify-clone/src/pages/playlist/[id].astro", "self");

const $$file = "C:/Users/ManDenDev/Workspace/aprendiendo-astro/projects/01-spotify-clone/src/pages/playlist/[id].astro";
